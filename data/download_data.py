...
print("Saving datasets from scikit")
#save cancer + iris datasets in numerical_classification
iris = datasets.load_iris()
pickle.dump(tuple((iris.data, iris.target)),open('data/numerical_only/balanced/iris','bw'))

cancer = datasets.load_breast_cancer()
pickle.dump(tuple((cancer.data, cancer.target)),open('data/numerical_only/balanced/cancer','bw'))